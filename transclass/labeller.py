...
class Labeller(object):
    ...
    def _train(self):
        training_set = [transaction for transaction in self.transactions if transaction.category]
    ...
    def render(self):
        ...
        sorted_transaction_predictions = sorted(zipped_transaction_predictions, key=lambda entry: entry[1][1])
        ...
        self.container.children = [headers, self.transaction_container, controls]
